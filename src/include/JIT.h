...
namespace slljit
{
	...
	public:
		...
		ShaderJIT()
		    : Resolver(createLegacyLookupResolver(
		          ES, [this](llvm::StringRef Name) { return findMangledSymbol(std::string(Name)); }, [](llvm::Error Err) { llvm::cantFail(std::move(Err), "lookupFlags failed"); }))
		...
		llvm::JITSymbol findSymbol(const std::string Name, llvm::orc::VModuleKey Module)
		{
	...
	private:
		...
		llvm::JITSymbol findMangledSymbol(const std::string& Name, llvm::orc::VModuleKey Module)
		{
#ifdef _WIN32
